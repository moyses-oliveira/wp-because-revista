...
?>
    <main class="layoutBody clearfix project">
        <article class="postSingle postSingle--fullwidth postSingle--headerWide hentry projects type-projects status-publish has-post-thumbnail">
                    ...
                    <div class="layoutContent-main">
                        ...
                        <div itemprop="" class="postContent postContent--fullwidth bodyCopy entry-content">
                            ...
                            <?php foreach($fields as $field): ?>
                                ...
                                <?php if($first): ?>
                                <div class="pergunta">
                                    <h2><?php echo $field['name'];?></h2> <?php echo $field['value'];?>
                                </div>
                                <?php $first=false; continue; endif; ?>
                    ...
                    <aside id="mdSidebar" class="layoutContent-sidebar sidebar">
                        ...
                        <div class="nossa_causa_sidebar_project">
                            ...
                            <div class="projects-same-city">
                                ...
                                <?php if($p['id'] === $project['data']['id']) { continue; } ?>
