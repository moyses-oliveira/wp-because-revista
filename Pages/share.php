...
<div class="addtoany_share_save_container addtoany_content addtoany_content_bottom">
    ...
    <div class="a2a_kit a2a_kit_size_32 addtoany_list"
      ...
      <span class="a2a_svg a2a_s__default a2a_s_google_plus" style="background-color: rgb(202, 224, 255);">
         <svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            <path d="M27 15h-2v-2h-2v2h-2v2h2v2h2v-2h2m-15-2v2.4h3.97c-.16 1.03-1.2 3.02-3.97 3.02-2.39 0-4.34-1.98-4.34-4.42s1.95-4.42 4.34-4.42c1.36 0 2.27.58 2.79 1.08l1.9-1.83C15.47 9.69 13.89 9 12 9c-3.87 0-7 3.13-7 7s3.13 7 7 7c4.04 0 6.72-2.84 6.72-6.84 0-.46-.05-.81-.11-1.16H12z"
                  fill="#FFF"></path>
         </svg>
      </span>
            <span class="a2a_label">google_plus</span>
        </a>
        <a class="a2a_dd addtoany_share_save addtoany_share"
           href="https://www.addtoany.com/share#url=https%3A%2F%2Ftransformando.com.vc%2Fprojeto%2Fconhecendo-lugares-e-suas-historias-atraves-da-leitura%2F&amp;title=Conhecendo%20lugares%20e%20suas%20hist%C3%B3rias%20atrav%C3%A9s%20da%20leitura">
      <span class="a2a_svg a2a_s__default a2a_s_a2a" style="background-color: rgb(1, 102, 255);">
         <svg focusable="false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
            ...
            <span class="a2a_label a2a_localize" data-a2a-localize="inner,Share">Compartilhar</span>
        </a>
    </div>
</div>