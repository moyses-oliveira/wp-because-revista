...
class Bootstrap {
    ...
    private function __construct() {
        ...
        $this->templates = array(
            #'Pages/projects.php' => 'Projetos &gt; revista.transformando.com.vc'
            #,'Pages/project.php' => 'Projeto &gt; revista.transformando.com.vc'
        );
...
add_action('plugins_loaded', array( Bootstrap::class, 'get_instance' ) );
